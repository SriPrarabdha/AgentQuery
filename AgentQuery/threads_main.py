from AgentQuery.agents.threads import Threads
...
from AgentQuery.modules import rand
from AgentQuery.modules import embeddings
import argparse
...
def main():
    ...
    with PostgresAgentInstruments(DB_URL, session_id) as (agent_instruments, db):
        ...
        print(f"Thread Assistant finished.")
